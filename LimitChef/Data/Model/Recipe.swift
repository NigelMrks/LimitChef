...
struct Recipe: Codable, Hashable {
    ...
    var strMeal: String = "Teriyaki Chicken Dummy"
    ...
    var strMealThumb: String = "https://www.themealdb.com/images/media/meals/wvpsxx1468256321.jpg"
    
    var strIngredient1: String? = "soy sauce"
    var strIngredient2: String? = "water"
    var strIngredient3: String? = "brown sugar" 
    var strIngredient4: String? = "ground ginger"
    var strIngredient5: String? = "minced garlic"
    var strIngredient6: String? = "cornstarch"
    var strIngredient7: String? = "chicken breasts"
    var strIngredient8: String? = "stir-fry vegetables"
    var strIngredient9: String? = "brown rice"
